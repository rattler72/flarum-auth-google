            ...
            if (empty($user->avatar_url)) {
                ...
                if (!empty($provided['avatar_url']) && (substr($provided['avatar_url'], -$length) === $target)){
                    ...
                    if ($res->getStatusCode() != 404 && $res->getStatusCode() != 500){
                        ...
                        $public_url = $this->site_url.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'avatars'.DIRECTORY_SEPARATOR.'user'.DIRECTORY_SEPARATOR.$user->id.DIRECTORY_SEPARATOR.$filename;
